<%@ Page Title="" Language="C#" MasterPageFile="~/main.Master" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="Green_veg_valley.index" %>
					...
					<ul class="slides">
						<li>
							<div class="w3l_banner_nav_right_banner">
								<h3>Make <span>food</span> with Spicy.</h3>
								<div class="more">
								...
								<figure>
									<div class="snipcart-item block" >
										<div class="snipcart-thumb">
											...
											<p>fortune sunflower oil ( 4*1L )</p>
											<h4>₹736 <span>₹920</span></h4>
										</div>
				...
				<div class="col-md-3 w3l_fresh_vegetables_grid w3l_fresh_vegetables_grid_left">
					<div class="w3l_fresh_vegetables_grid2">
						<ul>
							...
							<li><i class="fa fa-check" aria-hidden="true"></i><a href="household.html">Milk product</a></li>
